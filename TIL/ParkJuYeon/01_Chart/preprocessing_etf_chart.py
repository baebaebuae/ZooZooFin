from etf_stock_data import data as etf
from stock_id import etf as id
import pickle
...
with open('etf_chart.pkl', 'wb') as f:
    pickle.dump(result, f)

# pkl 파일을 읽어 Python 코드로 저장
with open('etf_chart.pkl', 'rb') as f:
    loaded_data = pickle.load(f)

# UTF-8 인코딩으로 .py 파일로 저장
with open('etf_chart.py', 'w', encoding='utf-8') as f:
