    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                ...
                if (
                    response.data.body &&
                    response.data.body.animals &&
                    response.data.body.animals.length > 0
                ) {
                ...
                <ContentWrapper>
                    ...
                    {animalData.animals.length === 0 ? (
                        <NoCharacterWrapper>
                            ...
                            <div></div>
                            <CustomButton size="large" color="primaryDeep" onClick={handleGoBack}>
                                돌아가기
                            </CustomButton>
                        </NoCharacterWrapper>
                    ) : (
                        animalData.animals.map((animal, index) => {
                            const CharacterComponent =
                                index === 0 ? Character1 : index === 1 ? Character2 : Character3;
                            const ImageComponent =
                                index === 2 ? SmallerCharacterImage : CharacterImage;
                            ...
                            return (
                                <CharacterComponent key={animal.animalId}>
                                    ...
                                    />
                                    <CharacterDate>
                                        {new Date(animal.createdDate).toLocaleDateString()}
                                    </CharacterDate>
                                    <CustomButton
                                        size="large"
                                        color="primaryDeep"
