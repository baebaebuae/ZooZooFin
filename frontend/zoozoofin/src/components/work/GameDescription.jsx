...
const Btn = styled.button`
    ...
    background: ${({ theme }) => `linear-gradient(180deg, #D1D9D1 10.81%, ${theme.colors.green} 100%)`};
...
const GameDescription = ({setOpenModal}) => {
    ...
    return (
        <Container>
            ...
            <Text>
                <GreenText>당근 받기 게임</GreenText>은 당근을 바구니에 받아서 투자에 필요한 재화를 얻는 <br/> 우리 도시의 대표 미니게임이야.
            </Text>
            <Text>
                <GreenText>20초 동안</GreenText> 하늘에서 떨어지는 당근을 <br/> 받으면 돼.
            </Text>
            <Text>
                그냥 당근은 <RedText>10당근</RedText>, 황금 당근은 무려 <RedText>100당근</RedText>으로 바꿔줄거야! <br/>어마어마하지?
            </Text>
            <Text>
                아참! 썩은 당근을 주워오면 <br/> 농작물에 피해가 막심하니 <br/> <RedText>100당근을 차감</RedText>한다는 걸 잊지마~!
            </Text>
            <Text>
                당근 받기 게임은 <br/><GreenText>1턴당 1번만</GreenText> 할 수 있으니까 <br/> 열심히 당근을 받아보라구!!
            </Text>
            </Content>
