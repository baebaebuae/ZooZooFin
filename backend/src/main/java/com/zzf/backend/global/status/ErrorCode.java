...
public enum ErrorCode {
    ...
    EXCHANGE_NOT_FOUND_EXCEPTION(404, "환율 정보가 존재하지 않습니다."),
    ...
    STOCK_HISTORY_NOT_FOUND(404, "주식 매매 기록이 존재하지 않습니다."),
    AI_SERVER_ERROR(500, "AI 서버 에러 발생"),

    // News
    NEWS_NOT_FOUND(404, "뉴스가 존재하지 않습니다."),
